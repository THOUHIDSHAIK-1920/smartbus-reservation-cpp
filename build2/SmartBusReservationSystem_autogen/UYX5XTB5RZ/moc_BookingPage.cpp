...
void BookingPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onSearchRoutes(); break;
        case 1: _t->onRouteSelected((*reinterpret_cast<std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<int>>(_a[2]))); break;
        case 2: _t->onSeatButtonClicked(); break;
        case 3: _t->onBookTicket(); break;
        case 4: _t->onGenerateTicket(); break;
        default: ;
        }
    }
}
